# Extracted Text from MASTER-PLAYBOOK-v2.2.docx

ENTERPRISE-GRADE SUPERVISED AUTONOMOUS CRYPTO TRADING PLATFORM

MASTER PLAYBOOK v2.0 UPGRADE LAYER
...
Collect and normalize real-time and historical crypto market data.

Analyse markets using technical analysis.

Analyse market structure and price action.

Analyse Smart Money Concepts.

Analyse Wyckoff methodology.

Analyse Fibonacci structures and confluence.

Analyse volume and order flow.

Analyse derivatives markets.
...
Analyse futures basis and related derivatives metrics where available.

Analyse on-chain activity.

Analyse tokenomics and project fundamentals.

Analyse news and events.

Analyse social sentiment.

Analyse macroeconomic/intermarket conditions.

Determine the current market regime.

Evaluate multiple trading strategies independently.

Combine strategy outputs using a transparent strategy ensemble.

Generate candidate trading signals.

Validate signals using historical and statistical evidence.

Produce a detailed Evidence Report.

Determine whether a signal is trade-eligible.

Apply deterministic risk management.

Present the opportunity to the human supervisor.

Allow the human supervisor to modify trade parameters.

Recalculate and revalidate risk after modifications.

Require explicit human approval before live execution.

Execute approved trades through a controlled exchange abstraction.

Monitor positions after execution.

Perform post-trade analysis.

Measure strategy and agent performance.

Continuously improve the analytical system through measured evidence rather than unsupported assumptions.
...
wait for the appropriate implementation prompt.
...
Agent/Service Responsibility Matrix
...
Acceptance Criteria for this foundation phase
...
Define precise operational rules.

Version those definitions.

Backtest them.

Do not allow an LLM to arbitrarily redefine them.
...
Strategy Ensemble Architecture

Bull/Bear Thesis Architecture
...
Final recommended agent topology

Agents that should be LLM-based

Components that should be deterministic

Components that should be conventional services

Components that should be LangGraph nodes/subgraphs

Recommended model-routing strategy

Recommended analysis pipeline

Recommended debate pipeline
...
Inspect existing architecture documents.

Identify what already exists.

Do not duplicate existing services.

Propose changes before modifying architecture.
