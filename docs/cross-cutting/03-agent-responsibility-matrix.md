...
|---|---|---|---|---|---|
| Data + Data Quality | Deterministic service | Market ingestion, normalization, source lineage, and quality state | `C-001`, `C-091`, `C-092` | `C-002`, `C-003` | Produces market/data truth and quality status only; cannot create signals, risk, approvals, or orders. |
