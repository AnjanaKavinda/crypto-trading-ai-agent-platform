# Issue 023 — Strategy/signal/no-trade contract schemas
...
## Objective
Implement StrategyVersion, eligibility, candidate, evidence package, qualification and NO_TRADE contracts.
